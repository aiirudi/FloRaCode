...
from flora_claude.core.tools.errors import RateLimitedError
...
async def _fail(
    ...
    *,
    ...
    return ToolResult(content=error_message, error_type=error_class, is_error= True)


# 校验参数、限时工具调用、发布进度事件，返回 ToolResult
    ...
    *, 
    ...
    if permission_manager is not None:
        ...
        if allowed:
            ...
            return await _fail(
                ...
                error_message="Permission denied by user. You may not execute this command. "
    ...
    for attempt in range(1, _MAX_RETRIES  + 2):
        ...
        try:
            ...
            return await _fail(
                bus, run_id, tool_call,
                "timeout", f"tool timed out after {timeout}s",
                elapsed(), attempt=attempt,
            )
